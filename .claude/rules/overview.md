...
- Support for 19 programming languages and frameworks (metrics, extraction, and dependency analysis)
...
- Java, Kotlin, TypeScript, TSX, JavaScript, Python, Go, PHP, Ruby, Swift, Bash, C#, C++, C, Objective-C, Vue, ABL, Delphi, Rust
